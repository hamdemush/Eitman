...
<div class="dash-layout">
  ...
  <aside class="dash-sidebar" id="dashSidebar">
    ...
    <nav class="dash-nav">
      ...
      <a href="patient-notes.html" class="active">
  ...
  <main class="dash-main">
    ...
    <div class="dash-head">
      <div><h1>المرضي</h1><p>السجل العلاجي وملاحظات الجلسات لكل مريض.</p></div>
    </div>
    ...
    <div class="dash-grid">
      ...
      <div>
        <!-- Session notes / treatment plan form for the selected patient.
             Loads dynamically based on which patient is clicked on the
             left, and persists per-patient via Store.savePatientNote(). -->
        <div class="panel">
