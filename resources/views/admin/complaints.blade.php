...
<head>
  ...
  <title>الشكاوى والتقارير | إطمئن</title>
...
<div class="dash-layout">
  ...
  <main class="dash-main">
    ...
    <div class="dash-head">
      <div><h1>الشكاوى والتقارير</h1><p>بلاغات المرضى والمعالجين، وحالات الطوارئ التي تحتاج متابعة إدارية.</p></div>
    </div>
    ...
    function render() {
      ...
      complaints.forEach((c) => {
        ...
        item.innerHTML =
          ...
          '</div>' +
          '<div style="flex:1;"><b>' + c.title + '</b><span>بلاغ من ' + c.complainantName + (c.accusedType !== 'system' ? ' بحق ' + c.accusedName : '') + ' — ' + c.dateLabel + '</span></div>' +
          '<span class="pill ' + statusPillClass[c.status] + '">' + statusLabels[c.status] + '</span>' +
          '<a href="complaint-details.html?id=' + c.id + '" class="btn btn-ghost btn-sm" style="margin-inline-start:10px;">معاينة</a>';
