...
<head>
  ...
  <title>اعتماد المعالجين | إطمئن</title>
...
<div class="dash-layout">
  ...
  <aside class="dash-sidebar" id="dashSidebar">
    ...
    <nav class="dash-nav">
      ...
      <a href="therapists.html" class="active">
  ...
  <main class="dash-main">
    ...
    <div class="dash-head">
      <div><h1>اعتماد المعالجين</h1><p>راجع طلبات انضمام المعالجين الجدد ووثائقهم قبل الموافقة.</p></div>
    </div>
    ...
    function render() {
      ...
      pending.forEach((a) => {
        ...
        tr.innerHTML =
          ...
          '<td><div class="table-actions"><a href="therapist-profile.html?id=' + encodeURIComponent(a.id) + '&source=' + a.source + '">عرض الملف</a></div></td>';
      ...
      approved.forEach((t) => {
        ...
        tr.innerHTML =
          ...
          '<td><div class="table-actions"><a href="therapist-profile.html?id=' + encodeURIComponent(t.id) + '&source=approved">عرض الملف</a></div></td>';
        tbody.appendChild(tr);
      });
      ...
      rejected.forEach((r) => {
        ...
        tr.innerHTML =
          ...
          '<td><div class="table-actions"><a href="therapist-profile.html?id=' + encodeURIComponent(r.id) + '&source=rejected">عرض السبب</a></div></td>';
        tbody.appendChild(tr);
      });
    }
