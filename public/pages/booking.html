...
<section class="section" style="padding-top:30px;">
  <div class="container" style="max-width:760px;">
    ...
    <!-- NOTE: front-end mockup - a real submit handler will POST the
         booking to the back-end. For now, confirming creates a *pending*
         session request via Store so it shows up on the therapist's
         "طلبات الاستشارة" page and can be accepted (which auto-creates
         the chat thread), landing on the patient dashboard afterwards. -->
