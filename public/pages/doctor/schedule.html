...
<div class="dash-layout">
  ...
  <main class="dash-main">
    ...
    <div class="dash-head">
      <div><h1>أوقات العمل</h1><p>حدّد الأوقات المتاحة لاستقبال جلسات جديدة خلال الأسبوع.</p></div>
      <button class="btn btn-primary btn-sm" id="saveScheduleBtn">حفظ التغييرات</button>
    </div>
    ...
    <div class="panel">
      <div class="schedule-grid">
        <div class="schedule-day">
          <h5>الأحد</h5>
          <div class="schedule-slot-toggle"><span>10:00 ص</span><input type="checkbox" checked></div>
          <div class="schedule-slot-toggle"><span>12:00 م</span><input type="checkbox" checked></div>
          <div class="schedule-slot-toggle"><span>4:00 م</span><input type="checkbox"></div>
        </div>
        <div class="schedule-day">
          <h5>الإثنين</h5>
          <div class="schedule-slot-toggle"><span>10:00 ص</span><input type="checkbox"></div>
          <div class="schedule-slot-toggle"><span>12:00 م</span><input type="checkbox" checked></div>
          <div class="schedule-slot-toggle"><span>4:00 م</span><input type="checkbox" checked></div>
        </div>
        <div class="schedule-day">
          <h5>الثلاثاء</h5>
          <div class="schedule-slot-toggle"><span>10:00 ص</span><input type="checkbox" checked></div>
          <div class="schedule-slot-toggle"><span>12:00 م</span><input type="checkbox"></div>
          <div class="schedule-slot-toggle"><span>4:00 م</span><input type="checkbox"></div>
        </div>
        <div class="schedule-day">
          <h5>الأربعاء</h5>
    ...
    <div class="panel" style="background:var(--lav-100); border-color:var(--lav-200);">
      <h4 style="margin-bottom:8px;">ملاحظة للربط مع الخلفية</h4>
      <p style="font-size:13px;">هذه الشبكة تمثيل بصري فقط. يفترض أن تُحفظ التغييرات عبر API مخصص لجدول أوقات كل معالج، وأن يُعاد جلبها ديناميكيًا بدل القيم الثابتة أعلاه.</p>
    </div>
  </main>
</div>
...
<script>
  document.getElementById('saveScheduleBtn').addEventListener('click', () => {
    ...
    toast.textContent = 'تم حفظ أوقات العمل بنجاح.';
