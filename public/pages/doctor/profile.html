...
<head>
  ...
  <title>الملف الشخصي | إطمئن</title>
...
<div class="dash-layout">
  ...
  <aside class="dash-sidebar" id="dashSidebar">
    ...
    <nav class="dash-nav">
      ...
      <a href="patient-notes.html">
        ...
        <span data-i18n="sidebar.patients">مرضاي</span>
      </a>
      <a href="chat.html">
  ...
  <main class="dash-main">
    ...
    <div class="dash-head">
      <div><h1>الملف الشخصي</h1><p>هذه المعلومات تظهر للمرضى في صفحتك العامة.</p></div>
    ...
    <div class="panel" style="max-width:680px;">
      ...
      <div class="field"><label>نبذة تعريفية</label>
    ...
    <!-- Certificates & experience section: populated dynamically from
         Store (either what the therapist attached at registration, or the
         seeded demo credential), fulfilling the "certificates must appear
         in the doctor dashboard" requirement. -->
...
<script>
  (function () {
    ...
    if (!therapist) therapist = Store.getTherapist('th-mariam'); // fallback to seed doctor
