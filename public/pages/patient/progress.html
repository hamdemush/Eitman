...
<head>
  ...
  <title>تقدمي النفسي | إطمئن</title>
...
<div class="dash-layout">
  ...
  <aside class="dash-sidebar" id="dashSidebar">
    ...
    <nav class="dash-nav">
      ...
      <a href="../specialists.html">
        ...
        <span data-i18n="sidebar.findSpecialist">ابحث عن معالج</span>
      </a>
  ...
  <main class="dash-main">
    ...
    <div class="dash-head">
      <div><h1>تقدمي النفسي</h1><p>متابعة دورية لمؤشر حالتك المزاجية وملاحظات معالجتك.</p></div>
    </div>

    <div class="stat-cards">
      <div class="stat-card"><div class="ico"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 3v18h18M7 15l4-5 3 3 5-6"/></svg></div><b>+18٪</b><span>تحسّن آخر شهر</span></div>
      <div class="stat-card"><div class="ico"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="5" width="18" height="16" rx="2"/><path d="M16 3v4M8 3v4M3 10h18"/></svg></div><b>6</b><span>استبيانات مكتملة</span></div>
      <div class="stat-card"><div class="ico"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg></div><b>6 أسابيع</b><span>مدة المتابعة</span></div>
    </div>
