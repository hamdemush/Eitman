...
<header class="site-header">
  <div class="container">
    ...
    <nav class="main-nav">
      ...
      <a href="about.html" class="active" data-i18n="nav.about">معلومات عنا</a>
...
<section class="section" style="padding-top:30px;">
  <div class="container" style="max-width:820px;">
    ...
    <img src="../assets/images/calm-plants-corner.webp" alt="ركن هادئ مليء بالنباتات يعكس روح الهدوء التي تقدمها إطمئن" style="width:100%; border-radius:var(--r-xl); margin-bottom:24px; display:block; box-shadow:var(--shadow-lg);">
